const cacheName = "app-" + "037df1db98948102425b3cf56ca936939c7c32a7";
const resourcesToCache = ["app.css","app.js","app.wasm","manifest.webmanifest","wasm_exec.js","index.html"];

self.addEventListener("install", (event) => {
  console.log("installing app worker 037df1db98948102425b3cf56ca936939c7c32a7");
...
self.addEventListener("activate", (event) => {
  ...
  console.log("app worker 037df1db98948102425b3cf56ca936939c7c32a7 is activated");
});
